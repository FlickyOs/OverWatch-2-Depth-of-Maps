ReShade Support Coming to GeForce Experience
============================================

GeForce gamers can tap into hundreds of ReShade filters and easily apply them in their favorite games using Freestyle or Ansel. 

This support greatly simplifies everything for the end user. Traditionally, ReShade has to be “injected” and installed for each game. With ReShade support, GeForce gamers can easily add their favorite ReShade filters once and then apply to over 650+ games using Freestyle and Ansel in-game overlay. 

Note that NVIDIA restricts certain Reshade filters on competitive games.  Our support based on game and filter type is as follows: 
...
ReShade support requires Game Ready Driver (441.07 or greater) & GeForce Experience (3.20.1.47 or greater) 

ADDING RESHADE FILTERS
----------------------
...
Next, activate either the Ansel (Alt-F2) or FreeStyle (Alt-F3) overlay.  Here, you can apply ReShade filters from the drop down ‘Filters’ menu and tune to your liking.  Some filters focus on subtle image quality improvements and minor tweaks, while others radically modify your gaming experience.  Try our our new submissions to ReShade Github Repository, Neon Retro (for games which exposes depth information) as well as Posterize. 

The full repository will be included as part of the official ReShade repository located at https://github.com/crosire/reshade-shaders/ New filters such as Neon Retro and Posterize will be uploaded to the repository starting Oct 29, 2019. 
...
These titles supports all 14 filters included in Game Ready Driver, 70+ officially supported ReShade filters, as well as any custom ReShade filter. 
